        ...
        <main className="min-h-screen selection:bg-zinc-800 flex flex-col">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-4 pt-20">
                <div className="max-w-md w-full space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <div className="bg-zinc-900/50 border border-zinc-800 rounded-3xl p-8 backdrop-blur-xl flex flex-col items-center gap-8 relative overflow-hidden transition-all duration-500">
                        <div className="w-full flex flex-col items-center gap-8 transition-all duration-700">
